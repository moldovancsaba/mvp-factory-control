...
| **[docs/agent-operating-document-reply.md](docs/agent-operating-document-reply.md)** | **Agent operating document — Reply project.** Project-related agentic rules for the Reply product (repo: reply); how Reply ties into the board; cold start, loopback, handoff. Stored here as part of the unified knowledge center. |
