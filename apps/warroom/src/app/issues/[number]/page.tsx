                    ...
                    <div className="mt-2 grid gap-2 sm:grid-cols-2">
                      ...
                      <label className="text-xs text-white/70">
                        ...
                        <input
                          ...
                          placeholder="docs/WARROOM_HANDOVER.md#..."
                          className="mt-1 w-full rounded-lg border border-white/15 bg-black/20 px-2 py-1.5 text-sm text-white/90 outline-none focus:border-white/25"
                        />
                      </label>
                    </div>
                    ...
                    <div className="mt-2 grid gap-2 sm:grid-cols-2">
                      ...
                      <label className="text-xs text-white/70">
                        ...
                        <input
                          ...
                          name="handoverRef"
                          required
                          placeholder="docs/WARROOM_HANDOVER.md#transfer"
                          className="mt-1 w-full rounded-lg border border-white/15 bg-black/20 px-2 py-1.5 text-sm text-white/90 outline-none focus:border-white/25"
                        />
                      </label>
                    </div>
                    ...
                    <div className="mt-2 grid gap-2 sm:grid-cols-2">
                      <label className="text-xs text-white/70">
                        ...
                        <input
                          ...
                          name="handoverRef"
                          required
                          placeholder="docs/WARROOM_HANDOVER.md#close"
                          className="mt-1 w-full rounded-lg border border-white/15 bg-black/20 px-2 py-1.5 text-sm text-white/90 outline-none focus:border-white/25"
                        />
                      </label>
                      <label className="text-xs text-white/70">
                    ...
                    <div className="mt-2 grid gap-2 sm:grid-cols-2">
                      ...
                      <label className="text-xs text-white/70">
                        ...
                        <input
                          ...
                          required
                          placeholder="docs/WARROOM_STATUS_BRAINDUMP.md#..."
                          className="mt-1 w-full rounded-lg border border-white/15 bg-black/20 px-2 py-1.5 text-sm text-white/90 outline-none focus:border-white/25"
                        />
                      </label>
                    </div>
